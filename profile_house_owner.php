		...
		<div class="profile">
			...
			<div class="col-md-offset-2 col-md-4">
				<div class="details">
					...
					<p><i class="fa fa-mobile" aria-hidden="true"></i> Phone: <?php echo $doc['house_owner_phone'];?> </p>
					<p><i class="fa fa-mobile" aria-hidden="true"></i> Mobile: <?php echo $doc['house_owner_mobile'];?> </p>
					<p><i class="fa fa-industry" aria-hidden="true"></i> Occupation: <?php echo $doc['house_owner_occupation'];?> </p>
				

				</div>
				<div class="list">
				<button type="button" onclick="window.location.href='edit_house_owner.php'" class="btn btn-success new"> Edit Profile</button>
				<br>
				<button type="button" onclick="window.location.href='view_my_flat.php'" class="btn btn-warning new"> Your Flats</button><br>
				<button type="button" onclick="window.location.href='add_flat.php'" class="btn btn-primary new"> Add Flat</button><br>
